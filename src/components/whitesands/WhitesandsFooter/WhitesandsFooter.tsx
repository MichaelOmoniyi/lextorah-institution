...
import styles from "./WhitesandsFooter.module.css";
...
interface WhitesandsFooterProps {
  logo: string;
  description: string;
...
export default function WhitesandsFooter({
  logo,
  description,
  quickLinks,
  poweredByText,
  copyright,
}: WhitesandsFooterProps) {
  return (
      ...
      <div className={styles.container}>
        <div className={styles.footerGrid}>
          ...
          <div className={styles.brandColumn}>
            <Image src={logo} alt="Whitesands Schools" width={32} height={32} className={styles.logo} />
